...
export default function Reviews() {
  ...
  return (
    <InfoShell eyebrow="Loved by gamers" title="Customer reviews"
      subtitle="Real feedback from real buyers — auto-published from our Discord community vouches." narrow={false}>
      <div className="flex flex-wrap items-center justify-center gap-6 mb-10">
        ...
        <div className="grid grid-cols-3 gap-6 text-center">
          {[[`${stats.delivered.toLocaleString('en-US')}+`, 'Delivered'], ['99.9%', 'Success'], [avgDelivery, 'Avg. delivery']].map(([n, l]) => (
