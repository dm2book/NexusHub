...
export const PAGES = {
  ...
  '/shop': {
    nl: {
      ...
      description: 'De volledige catalogus: Robux, V-Bucks, Valorant Points, Steam, Discord Nitro en giftcards. De prijs die je ziet is de prijs die je betaalt — geen verborgen kosten.',
    },
    en: {
      title: 'All products — game currency & gift cards',
      description: 'The full catalogue: Robux, V-Bucks, Valorant Points, Steam, Discord Nitro and gift cards. The price you see is the price you pay — no hidden fees.',
    },
    de: {
      title: 'Alle Produkte — Spielwährung & Geschenkkarten',
      description: 'Der ganze Katalog: Robux, V-Bucks, Valorant Points, Steam, Discord Nitro und Geschenkkarten. Der Preis, den du siehst, ist der Preis, den du zahlst — ohne versteckte Kosten.',
    },
    fr: {
  ...
  '/payment-methods': {
    nl: {
      title: 'Betaalmethoden — betaal met je bestelnummer',
      description: 'Je bestelt eerst en betaalt daarna, met je bestelnummer als referentie. Welke methoden er nu aanstaan zie je op de pagina zelf — die leest ze live uit de winkel.',
    },
    en: {
      title: 'Payment methods — pay with your order number',
      description: 'You order first and pay after, with your order number as the reference. Which methods are switched on is shown on the page itself — it reads them live from the shop.',
    },
    de: {
      title: 'Zahlungsmethoden — zahle mit deiner Bestellnummer',
      description: 'Du bestellst zuerst und zahlst danach, mit deiner Bestellnummer als Verwendungszweck. Welche Methoden aktiv sind, steht auf der Seite selbst — sie liest sie live aus dem Shop.',
    },
    fr: {
      title: 'Moyens de paiement — paie avec ton numéro de commande',
      description: 'Tu commandes d’abord et tu paies ensuite, avec ton numéro de commande comme référence. Les moyens actifs sont indiqués sur la page même — elle les lit en direct depuis la boutique.',
    },
  },
  '/track': {
    nl: {
...
export const LANDING = {
  '/robux': {
    ...
    nl: {
      ...
      description: 'Robux kopen. Wat op voorraad staat gaat automatisch de deur uit; de rest zetten we met de hand op je Roblox-account, meestal binnen een paar uur.',
      h1: 'Robux kopen',
    ...
    en: {
      ...
      description: 'Buy Robux. What is in stock goes out automatically; the rest we add to your Roblox account by hand, usually within a few hours.',
      h1: 'Buy Robux',
    ...
    de: {
      ...
      description: 'Robux kaufen. Was auf Lager ist, geht automatisch raus; den Rest buchen wir von Hand auf dein Roblox-Konto, meistens innerhalb weniger Stunden.',
      h1: 'Robux kaufen',
    ...
    fr: {
      ...
      description: 'Achète des Robux. Ce qui est en stock part automatiquement ; le reste, nous l’ajoutons à la main sur ton compte Roblox, en général en quelques heures.',
  ...
  '/v-bucks': {
    ...
    nl: {
      ...
      description: 'V-Bucks kopen. Op voorraad wordt automatisch geleverd, de rest met de hand binnen een paar uur.',
      h1: 'V-Bucks kopen',
      sub: 'V-Bucks voor Fortnite. Automatisch geleverd wanneer we voorraad hebben.',
    },
    en: {
      title: 'Buy V-Bucks for Fortnite — delivered fast',
      description: 'Buy V-Bucks. In stock is delivered automatically, the rest by hand within a few hours.',
      h1: 'Buy V-Bucks',
      sub: 'V-Bucks for Fortnite. Delivered automatically when we have stock.',
    },
    de: {
      title: 'V-Bucks für Fortnite kaufen — schnell geliefert',
      description: 'V-Bucks kaufen. Was auf Lager ist, wird automatisch geliefert, der Rest von Hand innerhalb weniger Stunden.',
      h1: 'V-Bucks kaufen',
      sub: 'V-Bucks für Fortnite. Automatisch geliefert, solange wir Lagerbestand haben.',
    },
    fr: {
      title: 'Acheter des V-Bucks pour Fortnite — livrés vite',
      description: 'Achète des V-Bucks. Ce qui est en stock est livré automatiquement, le reste à la main en quelques heures.',
      h1: 'Acheter des V-Bucks',
      sub: 'Des V-Bucks pour Fortnite. Livrés automatiquement tant que nous avons du stock.',
    },
  },
  '/valorant-points': {
    category: 'valorant',
    nl: {
      title: 'Valorant Points kopen — VP',
      description: 'Valorant Points kopen bij een Nederlandse shop. Betaal en krijg je VP automatisch of met de hand geleverd, meestal binnen een paar uur.',
      h1: 'Valorant Points kopen',
      sub: 'Valorant Points (VP). Automatisch als het op voorraad staat, anders met de hand binnen een paar uur.',
    },
    en: {
      title: 'Buy Valorant Points — VP',
      description: 'Buy Valorant Points from a Dutch shop. Pay and get your VP automatically or delivered by hand, usually within a few hours.',
      h1: 'Buy Valorant Points',
      sub: 'Valorant Points (VP). Automatic when in stock, otherwise by hand within a few hours.',
    },
    de: {
      title: 'Valorant Points kaufen — VP',
      description: 'Valorant Points bei einem niederländischen Shop kaufen. Zahle und erhalte deine VP automatisch oder von Hand geliefert, meistens innerhalb weniger Stunden.',
      h1: 'Valorant Points kaufen',
      sub: 'Valorant Points (VP). Automatisch, solange vorrätig, sonst von Hand innerhalb weniger Stunden.',
    },
    fr: {
      title: 'Acheter des Valorant Points — des VP',
      description: 'Achète des Valorant Points dans une boutique néerlandaise. Paie et reçois tes VP automatiquement ou livrés à la main, en général en quelques heures.',
      h1: 'Acheter des Valorant Points',
      sub: 'Des Valorant Points (VP). Automatique tant qu’il y a du stock, sinon à la main en quelques heures.',
    },
  },
  '/giftcards': {
    category: 'giftcard',
    nl: {
      ...
      description: 'Digitale giftcards voor Steam, PlayStation, Xbox, Netflix en meer. Code per e-mail, betalen, geld terug als we niet kunnen leveren.',
      h1: 'Giftcards kopen',
    ...
    en: {
      ...
      description: 'Digital gift cards for Steam, PlayStation, Xbox, Netflix and more. Code by email, pay, money back if we cannot deliver.',
      h1: 'Buy gift cards',
    ...
    de: {
      ...
      description: 'Digitale Geschenkkarten für Steam, PlayStation, Xbox, Netflix und mehr. Code per E-Mail, zahlen, Geld zurück, wenn wir nicht liefern können.',
    ...
    fr: {
      ...
      description: 'Cartes cadeaux numériques pour Steam, PlayStation, Xbox, Netflix et plus. Code par e-mail, paiement, remboursé si nous ne pouvons pas livrer.',
  ...
  '/fc-points': {
    ...
    nl: {
      ...
      description: 'FC Points kopen voor EA SPORTS FC. Op voorraad gaat automatisch de deur uit, de rest zetten we met de hand voor je klaar.',
      h1: 'FC Points kopen',
      sub: 'FC Points voor EA SPORTS FC, voor packs en Ultimate Team. Betalen, levering automatisch of met de hand.',
    },
    en: {
      title: 'Buy FC Points for EA FC — delivered fast',
      description: 'Buy FC Points for EA SPORTS FC. In stock goes out automatically, the rest we prepare by hand.',
      h1: 'Buy FC Points',
      sub: 'FC Points for EA SPORTS FC, for packs and Ultimate Team. Pay, delivered automatically or by hand.',
    },
    de: {
      title: 'FC Points für EA FC kaufen — schnell geliefert',
      description: 'FC Points für EA SPORTS FC kaufen. Was auf Lager ist, geht automatisch raus, den Rest bereiten wir von Hand vor.',
      h1: 'FC Points kaufen',
      sub: 'FC Points für EA SPORTS FC, für Packs und Ultimate Team. Zahle, geliefert automatisch oder von Hand.',
    },
    fr: {
      title: 'Acheter des FC Points pour EA FC — livrés vite',
      description: 'Achète des FC Points pour EA SPORTS FC. Ce qui est en stock part automatiquement, le reste, nous le préparons à la main.',
      h1: 'Acheter des FC Points',
      sub: 'Des FC Points pour EA SPORTS FC, pour les packs et Ultimate Team. Paie, livré automatiquement ou à la main.',
    },
  },
  '/cod-points': {
    category: 'cod',
    nl: {
      title: 'CoD Points kopen — Call of Duty CP',
      description: 'CoD Points (CP) kopen voor Call of Duty en Warzone. Wat op voorraad staat gaat automatisch de deur uit.',
      h1: 'CoD Points kopen',
      sub: 'CP voor Call of Duty en Warzone — voor bundles, skins en de Battle Pass.',
    },
    en: {
      title: 'Buy CoD Points — Call of Duty CP',
      description: 'Buy CoD Points (CP) for Call of Duty and Warzone. What is in stock goes out automatically.',
      h1: 'Buy CoD Points',
      sub: 'CP for Call of Duty and Warzone — for bundles, skins and the Battle Pass.',
    },
    de: {
      title: 'CoD Points kaufen — Call of Duty CP',
      description: 'CoD Points (CP) für Call of Duty und Warzone kaufen. Was auf Lager ist, geht automatisch raus.',
      h1: 'CoD Points kaufen',
      sub: 'CP für Call of Duty und Warzone — für Bundles, Skins und den Battle Pass.',
    },
    fr: {
      title: 'Acheter des CoD Points — des CP Call of Duty',
      description: 'Achète des CoD Points (CP) pour Call of Duty et Warzone. Ce qui est en stock part automatiquement.',
  ...
  '/apex-coins': {
    category: 'apex',
    nl: {
      title: 'Apex Coins kopen — Apex Legends',
      description: 'Apex Coins kopen voor Apex Legends. Op voorraad wordt automatisch geleverd, de rest met de hand.',
      h1: 'Apex Coins kopen',
      sub: 'Apex Coins voor Apex Legends — voor legends, skins en de Battle Pass.',
    },
    en: {
      title: 'Buy Apex Coins — Apex Legends',
      description: 'Buy Apex Coins for Apex Legends. In stock is delivered automatically, the rest by hand.',
      h1: 'Buy Apex Coins',
      sub: 'Apex Coins for Apex Legends — for legends, skins and the Battle Pass.',
    },
    de: {
      title: 'Apex Coins kaufen — Apex Legends',
      description: 'Apex Coins für Apex Legends kaufen. Was auf Lager ist, wird automatisch geliefert, der Rest von Hand.',
      h1: 'Apex Coins kaufen',
      sub: 'Apex Coins für Apex Legends — für Legenden, Skins und den Battle Pass.',
    },
    fr: {
      title: 'Acheter des Apex Coins — Apex Legends',
      description: 'Achète des Apex Coins pour Apex Legends. Ce qui est en stock est livré automatiquement, le reste à la main.',
  ...
  '/genshin-crystals': {
    ...
    nl: {
      ...
      description: 'Genesis Crystals kopen voor Genshin Impact. Automatisch geleverd wanneer we voorraad hebben, anders met de hand.',
    ...
    en: {
      ...
      description: 'Buy Genesis Crystals for Genshin Impact. Delivered automatically when in stock, otherwise by hand.',
    ...
    de: {
      ...
      description: 'Genesis Crystals für Genshin Impact kaufen. Automatisch geliefert, solange vorrätig, sonst von Hand.',
    ...
    fr: {
      ...
      description: 'Achète des Genesis Crystals pour Genshin Impact. Livrés automatiquement tant qu’il y a du stock, sinon à la main.',
  ...
  '/clash-of-clans-gems': {
    category: 'clash',
    nl: {
      title: 'Clash of Clans Gems kopen —',
      description: 'Gems kopen voor Clash of Clans. Wat op voorraad staat gaat automatisch de deur uit, de rest binnen een paar uur.',
      h1: 'Clash of Clans Gems kopen',
      sub: 'Gems voor Clash of Clans — voor builders, boosts en de Gold Pass.',
    },
    en: {
      title: 'Buy Clash of Clans Gems —',
      description: 'Buy Gems for Clash of Clans. What is in stock goes out automatically, the rest within a few hours.',
      h1: 'Buy Clash of Clans Gems',
      sub: 'Gems for Clash of Clans — for builders, boosts and the Gold Pass.',
    },
    de: {
      title: 'Clash of Clans Gems kaufen —',
      description: 'Gems für Clash of Clans kaufen. Was auf Lager ist, geht automatisch raus, der Rest innerhalb weniger Stunden.',
      h1: 'Clash of Clans Gems kaufen',
      sub: 'Gems für Clash of Clans — für Bauarbeiter, Boosts und den Gold Pass.',
    },
    fr: {
      title: 'Acheter des gemmes Clash of Clans —',
      description: 'Achète des gemmes pour Clash of Clans. Ce qui est en stock part automatiquement, le reste en quelques heures.',
  ...
  '/clash-royale-gems': {
    ...
    nl: {
      ...
      description: 'Gems kopen voor Clash Royale. Op voorraad wordt automatisch geleverd, de rest zetten we met de hand voor je klaar.',
    ...
    en: {
      ...
      description: 'Buy Gems for Clash Royale. In stock is delivered automatically, the rest we prepare by hand.',
    ...
    de: {
      ...
      description: 'Gems für Clash Royale kaufen. Was auf Lager ist, wird automatisch geliefert, den Rest bereiten wir von Hand vor.',
    ...
    fr: {
      ...
      description: 'Achète des gemmes pour Clash Royale. Ce qui est en stock est livré automatiquement, le reste, nous le préparons à la main.',
  ...
  '/brawl-stars-gems': {
    category: 'brawl',
    nl: {
      title: 'Brawl Stars Gems kopen —',
      description: 'Gems kopen voor Brawl Stars. Automatisch geleverd zodra er voorraad is.',
      h1: 'Brawl Stars Gems kopen',
      sub: 'Gems voor Brawl Stars — voor brawlers, skins en de Brawl Pass.',
    },
    en: {
      title: 'Buy Brawl Stars Gems —',
      description: 'Buy Gems for Brawl Stars. Delivered automatically as soon as stock is there.',
      h1: 'Buy Brawl Stars Gems',
      sub: 'Gems for Brawl Stars — for brawlers, skins and the Brawl Pass.',
    },
    de: {
      title: 'Brawl Stars Gems kaufen —',
      description: 'Gems für Brawl Stars kaufen. Geliefert wird automatisch, sobald Lagerbestand da ist.',
      h1: 'Brawl Stars Gems kaufen',
      sub: 'Gems für Brawl Stars — für Brawler, Skins und den Brawl Pass.',
    },
    fr: {
      title: 'Acheter des gemmes Brawl Stars —',
      description: 'Achète des gemmes pour Brawl Stars. La livraison est automatique dès qu’il y a du stock.',
  ...
  '/free-fire-diamonds': {
    ...
    nl: {
      ...
      description: 'Diamonds kopen voor Free Fire. Wat op voorraad staat gaat automatisch de deur uit, de rest met de hand binnen een paar uur.',
    ...
    en: {
      ...
      description: 'Buy Diamonds for Free Fire. What is in stock goes out automatically, the rest by hand within a few hours.',
    ...
    de: {
      ...
      description: 'Diamonds für Free Fire kaufen. Was auf Lager ist, geht automatisch raus, der Rest von Hand innerhalb weniger Stunden.',
    ...
    fr: {
      ...
      description: 'Achète des diamants pour Free Fire. Ce qui est en stock part automatiquement, le reste à la main en quelques heures.',
  ...
  '/riot-points': {
    ...
    nl: {
      ...
      description: 'Riot Points (RP) kopen voor League of Legends. Automatisch geleverd wanneer we voorraad hebben.',
    ...
    en: {
      ...
      description: 'Buy Riot Points (RP) for League of Legends. Delivered automatically when in stock.',
      h1: 'Buy Riot Points',
      sub: 'RP for League of Legends — for champions, skins and the Battle Pass.',
    },
    de: {
      title: 'Riot Points kaufen — RP für League of Legends',
      description: 'Riot Points (RP) für League of Legends kaufen. Automatisch geliefert, solange vorrätig.',
    ...
    fr: {
      ...
      description: 'Achète des Riot Points (RP) pour League of Legends. Livrés automatiquement tant qu’il y a du stock.',
  ...
  '/gta-shark-cards': {
    ...
    nl: {
      ...
      description: 'Shark Cards kopen voor GTA Online. Betaal en krijg je in-game cash automatisch of met de hand geleverd.',
    ...
    en: {
      ...
      description: 'Buy Shark Cards for GTA Online. Pay and get your in-game cash automatically or delivered by hand.',
    ...
    de: {
      ...
      description: 'Shark Cards für GTA Online kaufen. Zahle und erhalte dein Ingame-Geld automatisch oder von Hand geliefert.',
    ...
    fr: {
      ...
      description: 'Achète des Shark Cards pour GTA Online. Paie et reçois ton argent en jeu automatiquement ou livré à la main.',
  ...
  '/minecoins': {
    category: 'minecraft',
    nl: {
      title: 'Minecoins kopen — Minecraft',
      description: 'Minecoins kopen voor Minecraft. Op voorraad gaat automatisch de deur uit, de rest met de hand.',
      h1: 'Minecoins kopen',
      sub: 'Minecoins voor Minecraft — voor skins, werelden en texture packs.',
    },
    en: {
      title: 'Buy Minecoins — Minecraft',
      description: 'Buy Minecoins for Minecraft. In stock goes out automatically, the rest by hand.',
      h1: 'Buy Minecoins',
      sub: 'Minecoins for Minecraft — for skins, worlds and texture packs.',
    },
    de: {
      title: 'Minecoins kaufen — Minecraft',
      description: 'Minecoins für Minecraft kaufen. Was auf Lager ist, geht automatisch raus, der Rest von Hand.',
      h1: 'Minecoins kaufen',
      sub: 'Minecoins für Minecraft — für Skins, Welten und Texture Packs.',
    },
    fr: {
      title: 'Acheter des Minecoins — Minecraft',
      description: 'Achète des Minecoins pour Minecraft. Ce qui est en stock part automatiquement, le reste à la main.',
  ...
  '/pubg-uc': {
    category: 'pubg',
    nl: {
      title: 'PUBG UC kopen — Unknown Cash',
      description: 'UC kopen voor PUBG Mobile. Wat op voorraad staat wordt automatisch geleverd, de rest binnen een paar uur.',
      h1: 'PUBG UC kopen',
      sub: 'Unknown Cash voor PUBG Mobile — voor crates, skins en de Royale Pass.',
    },
    en: {
      title: 'Buy PUBG UC — Unknown Cash',
      description: 'Buy UC for PUBG Mobile. What is in stock is delivered automatically, the rest within a few hours.',
      h1: 'Buy PUBG UC',
      sub: 'Unknown Cash for PUBG Mobile — for crates, skins and the Royale Pass.',
    },
    de: {
      title: 'PUBG UC kaufen — Unknown Cash',
      description: 'UC für PUBG Mobile kaufen. Was auf Lager ist, wird automatisch geliefert, der Rest innerhalb weniger Stunden.',
      h1: 'PUBG UC kaufen',
      sub: 'Unknown Cash für PUBG Mobile — für Kisten, Skins und den Royale Pass.',
    },
    fr: {
      title: 'Acheter des UC PUBG — de l’Unknown Cash',
      description: 'Achète des UC pour PUBG Mobile. Ce qui est en stock est livré automatiquement, le reste en quelques heures.',
  ...
  '/mobile-legends-diamonds': {
    ...
    nl: {
      ...
      description: 'Diamonds kopen voor Mobile Legends: Bang Bang. Automatisch geleverd zodra er voorraad is, anders met de hand.',
    ...
    en: {
      ...
      description: 'Buy Diamonds for Mobile Legends: Bang Bang. Delivered automatically as soon as stock is there, otherwise by hand.',
    ...
    de: {
      ...
      description: 'Diamonds für Mobile Legends: Bang Bang kaufen. Geliefert wird automatisch, sobald Lagerbestand da ist, sonst von Hand.',
    ...
    fr: {
      ...
      description: 'Achète des diamants pour Mobile Legends: Bang Bang. Livrés automatiquement dès qu’il y a du stock, sinon à la main.',
  ...
  '/pokemon-go': {
    category: 'pokemongo',
    nl: {
      title: 'Pokemon GO munten kopen — PokéCoins',
      description: 'PokéCoins kopen voor Pokemon GO. Op voorraad wordt automatisch geleverd, de rest met de hand.',
      h1: 'PokéCoins kopen',
      sub: 'PokéCoins voor Pokemon GO — voor items, opslag en raids.',
    },
    en: {
      title: 'Buy Pokemon GO coins — PokéCoins',
      description: 'Buy PokéCoins for Pokemon GO. In stock is delivered automatically, the rest by hand.',
      h1: 'Buy PokéCoins',
      sub: 'PokéCoins for Pokemon GO — for items, storage and raids.',
    },
    de: {
      title: 'Pokémon GO Münzen kaufen — PokéCoins',
      description: 'PokéCoins für Pokémon GO kaufen. Was auf Lager ist, wird automatisch geliefert, der Rest von Hand.',
      h1: 'PokéCoins kaufen',
      sub: 'PokéCoins für Pokémon GO — für Items, mehr Speicherplatz und Raids.',
    },
    fr: {
      title: 'Acheter des pièces Pokémon GO — des PokéCoins',
      description: 'Achète des PokéCoins pour Pokémon GO. Ce qui est en stock est livré automatiquement, le reste à la main.',
  ...
  '/discord-nitro': {
    ...
    nl: {
      ...
      description: 'Discord Nitro kopen. De code komt per e-mail; op voorraad gaat automatisch de deur uit, de rest met de hand.',
    ...
    en: {
      ...
      description: 'Buy Discord Nitro. The code arrives by email; in stock goes out automatically, the rest by hand.',
    ...
    de: {
      ...
      description: 'Discord Nitro kaufen. Der Code kommt per E-Mail; was auf Lager ist, geht automatisch raus, der Rest von Hand.',
    ...
    fr: {
      ...
      description: 'Achète Discord Nitro. Le code arrive par e-mail ; ce qui est en stock part automatiquement, le reste à la main.',
  ...
  '/game-currency': {
    ...
    nl: {
      ...
      description: 'Game currency voor Roblox, Fortnite, Valorant en meer, bij één Nederlandse shop. Betalen, levering automatisch of met de hand.',
    ...
    en: {
      ...
      description: 'Game currency for Roblox, Fortnite, Valorant and more, from one Dutch shop. Pay, delivered automatically or by hand.',
    ...
    de: {
      ...
      description: 'Spielwährung für Roblox, Fortnite, Valorant und mehr, aus einem niederländischen Shop. Zahle, geliefert automatisch oder von Hand.',
    ...
    fr: {
      ...
      description: 'De la monnaie de jeu pour Roblox, Fortnite, Valorant et plus, depuis une boutique néerlandaise. Paie, livraison automatique ou à la main.',
 ...
 * that gets one.
 *
 * `paymentAccepted` was the same risk, already taken. It was the hardcoded
 * string "iDEAL, Bancontact, Apple Pay, Credit Card, PayPal" — five providers
 * this shop does not accept. It takes Tikkie, by hand, with the order number
 * as the reference. A machine-readable claim about how a buyer can pay, that
 * the checkout then contradicts, is the version of this that is worst: a
 * reader can see the checkout, a crawler cannot.
 *
 * So it comes from the caller now, and is omitted when the caller does not
 * know — exactly like the address.
 */
export function organizationLd({ email, legal, paymentAccepted } = {}) {
  const ld = {
  ...
  if (paymentAccepted) ld.paymentAccepted = paymentAccepted;
  if (email) {
    ld.contactPoint = {
