...
const NL = {
  ...
  'footer.giftcards': 'Giftcards',
  'footer.gameCurrency': 'Game currency',
  'discord.linked': 'Discord gekoppeld. Je rollen komen eraan.',
  'discord.linkFailed': 'Discord koppelen is niet gelukt.',
  'discord.unlinkConfirm': 'Discord ontkoppelen? Je rollen in de server worden dan ook verwijderd.',
  'discord.unlinkedRoles': 'Ontkoppeld. {n} rol(len) verwijderd.',
  'discord.unlinked': 'Ontkoppeld.',
  'discord.synced': 'Bijgewerkt: {roles}',
  'discord.upToDate': 'Alles staat al goed.',
  'discord.connectedTo': 'Gekoppeld als',
  'discord.notConnected': 'Nog niet gekoppeld — koppel het om je rollen in de server te krijgen.',
  'discord.resync': 'Rollen verversen',
  'discord.disconnect': 'Ontkoppelen',
  'discord.connect': 'Discord koppelen',
  'discord.yourRoles': 'Jouw rollen',
  'discord.earnedNotApplied': 'Deze heb je al verdiend — koppel Discord en word lid van de server om ze te krijgen.',
  'discord.noRolesYet': 'Nog geen. Je eerste bestelling levert de klantrol op, en een review nog een.',
  'discord.hint.customer': 'Elke betaalde bestelling',
  'discord.hint.vip': 'Totale besteding boven de VIP-grens',
  'discord.hint.review': 'Een review achterlaten, hier of met /vouch',
  'discord.openServer': 'Open {name}',
  ...
  'launch.notify': 'Hou me op de hoogte',
  ...
  'home.trustWho2': 'geen gezichtsloze webshop — naam en contact op elke pagina',
  'home.trustPayLead': 'Je betaalt pas na je bestelling',
  'home.trustPay2': 'met je bestelnummer als kenmerk. Er wordt niets automatisch afgeschreven en er worden geen kaartgegevens opgeslagen',
  'home.trustBackLead': 'Geld volledig terug als we niet kunnen leveren',
  'home.trustBack2': 'zwart op wit op de retourpagina, geen coulance',
  'home.endTitle': 'Nog aan het twijfelen? Er wordt niets afgeschreven tot jij het zegt.',
  'home.endSub': 'Je plaatst eerst je bestelling en maakt daarna het exacte bedrag over. Kunnen we niet leveren, dan krijg je alles terug.',
  'home.endCta': 'Bekijk de winkel · vanaf {price}',
  'home.askFirst': 'Stel eerst een vraag',
  'pd.stockPaused': 'Op dit moment geen bestellingen',
  'pd.stockPausedSub': 'Je kunt dit wel in je mandje leggen en rustig doorlezen — bij het afrekenen zie je meteen wanneer het weer open is.',
  'pd.tPayAfter': 'Je betaalt pas na je bestelling — er wordt niets automatisch afgeschreven',
  'product.per1k': 'per 1.000',
  'product.perUnitCheaper': '{pct}% goedkoper per 1.000',
  'product.noReviewsWhy': 'Een review hier kan alleen vanuit een geleverde bestelling geschreven worden, dus deze vult zich op het tempo waarop de winkel echt verkoopt. Tot die tijd lenen we niets van elders.',
  'home.from': 'Vanaf',
  ...
  'track.needsTitle': 'We hebben nog één ding van je nodig',
  'track.needsSub': 'Deze bestelling leveren we rechtstreeks op je account, dus we hebben je {field} nodig. Beantwoord je bestelmail met alleen dat gegeven, dan gaat hij meteen de deur uit — we vragen nooit om je wachtwoord.',
  'track.needsCta': 'Stuur het ons door →',
  ...
  'track.mine': 'Bestellingen van dit apparaat',
  'track.mineSub': 'Alleen in deze browser bewaard, zodat je de mail niet hoeft op te zoeken.',
  'track.mineForget': 'Vergeet deze bestelling',
  'track.q1': 'Waar vind ik mijn bestelnummer?',
  'track.a1': 'In de bevestigingsmail die je direct na je bestelling kreeg — hij begint met FM- en is ook de referentie van je betaling. Geen mail? Kijk in spam en vraag het anders aan ons.',
  'track.q2': 'Hoe lang duurt de levering?',
  'track.a2': 'Zit het op voorraad, dan gaat het automatisch de deur uit zodra je betaling bevestigd is. De rest kopen we voor je in en leveren we met de hand, meestal binnen een paar uur overdag.',
  'track.q3': 'Ik heb betaald maar er gebeurt niets',
  'track.a3': 'Wij bevestigen elke betaling met de hand. Tot dat moment staat je bestelling op “wacht op betaling” — de eerste minuten is dat dus gewoon normaal. Zoek hem hierboven op; de pagina werkt zichzelf bij.',
  'track.q4': 'Kom je er niet uit?',
  'track.a4': 'Geef ons je bestelnummer, dan zoeken wij het op. Je krijgt antwoord van een mens — geen bot.',
  'track.allOrders': 'Bekijk al je bestellingen',
  ...
  'drops.wishlistWord': 'verlanglijst',
  ...
  'checkout.refNeeded': 'Zet je bestelnummer in de omschrijving van de betaling',
  'checkout.refWhy': '{label} stuurt het niet mee, en het is het enige dat je betaling aan deze bestelling koppelt.',
  'track.refNeeded': 'zet je bestelnummer erbij',
  ...
  'pay.s1d': 'Kies een van de methoden hierboven — dat zijn de methoden die nu aanstaan.',
  'pay.s2': 'Betaal met je bestelnummer',
  'pay.s2d': 'Gebruik je bestelnummer (bijv. FM-2026-XXXX) als betaalreferentie.',
  'pay.s3': 'Wij bevestigen, daarna gaat het de deur uit',
  'pay.s3d': 'Zodra je betaling bevestigd is gaat alles wat op voorraad ligt automatisch de deur uit; de rest volgt met de hand.',
  ...
  'checkout.p2': 'Verstuurd zodra je betaling bevestigd is',
